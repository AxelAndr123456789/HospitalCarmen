// DireccionDashboard Component - v3
...
export class DireccionDashboard implements OnInit {
  ...
  activeView: 'inicio' | 'documents_received' | 'documents_signed' | 'documents_sent' | 'expedientes' | 'reportes' | 'configuracion' | 'sign_interface' = 'inicio';
